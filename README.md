# 🌊 QUONIAM: Fluid Dynamics Audio Engine
...
## ✨ Key Features
* **🎹 Hybrid Engine:** Seamlessly blends real-world ambience loops (Rain, Wind, City) with procedural MIDI orchestration (Piano, Strings, Zen Bells).
* **🎨 Liquid Glass UI:** A modern, responsive interface built entirely in Python with Flet.
* **🧠 Emotional Intelligence:** Select moods (Cyber, Zen, Winter, Void) that instantly adapt the color palette and sonic texture.
...
git clone [https://github.com/Romainqnm/Quoniam.git](https://github.com/Romainqnm/Quoniam.git)
cd Quoniam
